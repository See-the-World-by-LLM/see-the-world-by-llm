...
*   **Grüner Veltliner (The Wine, Obviously):** You cannot leave Krems without guzzling its signature white wine. It’s crisp, peppery, refreshing, and pairs beautifully with everything from fish to, well, more wine. Visit a Heuriger (wine tavern) and order a "Viertel" (a quarter liter). Do it.
...
*   **Lunch (12:30 PM):** Find a traditional **Heuriger**. These are family-run wine taverns, often with gardens, serving simple, delicious local food and, crucially, their own wine. Order a plate of local charcuterie/cheese, some Laberl bread, and a glass of Grüner Veltliner. Relax. This is the Krems vibe.
...
*   **Late Afternoon (4:30 PM):** **Wine Tasting!** Duck into one of the many **Vinotheks** (wine shops) along the **Kunstmeile** (Art Mile) or near the Old Town. Sample a flight of local wines – Grüner Veltliner, Riesling, maybe a sweet dessert wine. Ask questions; the staff are usually passionate and knowledgeable.
...
*   **Etiquette:**
    *   **Heuriger Hacks:** Cash is often king here, especially at smaller, family-run spots. Don't be afraid to share a table if it's busy – it's common! Say "Grüß Gott" (Gree-us Got) when entering, "Prost" with eye contact when toasting, and "Danke" (Dahn-keh) when leaving.
